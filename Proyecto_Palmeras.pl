...
solve_dfs(pwb(Posicion,Bucket,[],Movidas,Tiempo),[],Historia,TiempoPreFinal):-
	Bucket \= 0,
	Posicion \= well,
	move(pwb(Posicion,Bucket,[],Historia,Tiempo),EstadoPreFinal,Movida),
	update(EstadoPreFinal,_,EstadoFinal,TiempoFinal),
	solve_dfs(EstadoFinal,[],Historia,TiempoFinal).


solve_dfs(Estado,[],Historia,Tiempo) :- 
	final_state(Estado,Historia,Tiempo).
...
final_state(pwb(well,Bucket,[],Historia,Tiempo),Historia,Tiempo) :-
	Bucket == 0,
...
update(pwb(Posicion,Bucket,Palmeras,Historia,Tiempo),Movida, pwb(Posicion,Bucket,Palmeras,Historia,Tiempo2),Tiempo2):-
	Palmeras == [],
	Tiempo2 is Tiempo.
...
move(pwb(Posicion,Bucket,Movidas,Historia,Tiempo),pwb(Movida,Bucket2,Movidas,Historia,Tiempo2),Movida):-
	...
	bucket(Bucket2),
	palm2well(Movida,Cantidad),
	Tiempo2 is Tiempo+Bucket2+Cantidad+Cantidad.
